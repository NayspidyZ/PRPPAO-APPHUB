# 🚀 PR-PPAO APP HUB (ศูนย์รวมแอปพลิเคชันและระบบงาน ฝ่ายการประชาสัมพันธ์ องค์การบริหารส่วนจังหวัดภูเก็ต)

เว็บพอร์ทัลศูนย์รวมแอปพลิเคชันและระบบงานของฝ่ายการประชาสัมพันธ์ องค์การบริหารส่วนจังหวัดภูเก็ต พัฒนาด้วย **Next.js (App Router)**, **Tailwind CSS** และใช้ **Google Sheets เป็นฐานข้อมูลผ่าน Google Apps Script** พร้อมสำหรับการนำขึ้น **GitHub** และ Deploy อัตโนมัติบน **Vercel**
...
- 📁 **ระบบจัดการหมวดหมู่ (Category Management):** สามารถ เพิ่ม, ลบ, แก้ไขชื่อ และจัดลำดับหมวดหมู่ได้อย่างอิสระ ซิงก์กับแท็บชีต `Categories`
- 📊 **Google Sheets Database:** ใช้ Google Sheets เก็บข้อมูล (ชีต `Apps` และ `Categories`) เจ้าหน้าที่เปิดดูและแก้ไขในสเปรดชีตได้ตรงๆ
