        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-sky-200/80">ศูนย์รวมแอปพลิเคชันและระบบงาน ฝ่ายประชาสัมพันธ์ องค์การบริหารส่วนจังหวัด</p>
            </div>
          </div>
        ...
        <div className="pt-8 pb-6 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-sm sm:text-base text-sky-100/80 max-w-2xl leading-relaxed">
              เข้าถึงทุกระบบงาน เครื่องมือผลิตสื่อ คลังภาพ และบริการประชาสัมพันธ์ของ อบจ. ได้สะดวกรวดเร็วในจุดเดียว
            </p>
          </div>
