      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          <div className="flex items-center gap-2 text-slate-700 font-semibold">
            ...
            <span>PR-PPAO APP HUB &bull; ฝ่ายประชาสัมพันธ์ องค์การบริหารส่วนจังหวัด</span>
          </div>
        ...
        <div className="mt-4 pt-4 border-t border-slate-200/60 text-center text-slate-600 text-[11px]">
          &copy; {new Date().getFullYear()} PR-PPAO. All rights reserved. พัฒนาขึ้นเพื่อเพิ่มประสิทธิภาพการทำงานและประสานงานภายในฝ่ายประชาสัมพันธ์
        </div>
      </div>
    </footer>
  );
